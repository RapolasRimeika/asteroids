...
PLAYER_SHOT_DMG = 40
SHOT_EXPLOSION_BUFFER = SHOT_RADIUS
...
# Explosion settings
EXPLOSION_NEAR_STRENGTH = 200
EXPLOSION_MID_STRENGTH = 100
EXPLOSION_FAR_STRENGTH = 50
...
MIN_SHRAPNEL_SPEED = PLAYER_SHOT_SPEED / 10
